          ...
          <div className="mt-8 md:mt-auto px-6 md:px-8 pb-6 md:pb-8 flex items-center justify-between w-full max-w-lg mx-auto md:max-w-none">
            ...
            <div className="flex gap-2 sm:gap-3">
              <button
                ...
                className="flex items-center justify-center gap-1.5 w-10 h-10 sm:w-12 sm:h-12 rounded-md transition-colors bg-stone-200 hover:bg-stone-300 text-stone-700 disabled:opacity-0 disabled:pointer-events-none"
              >
              ...
              <button
                ...
                className={`flex items-center justify-center gap-1.5 sm:gap-2 px-5 sm:px-6 h-10 sm:h-12 rounded-md font-bold transition-all duration-200 text-sm sm:text-base ${
                  isLastStep
                    ...
                    : "bg-stone-900 hover:bg-stone-800 text-stone-50 shadow-md hover:shadow-lg"
